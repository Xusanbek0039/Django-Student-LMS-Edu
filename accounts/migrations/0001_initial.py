# Generated by Django 4.0.8 on 2024-03-28 21:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=60, null=True)),
                ('email', models.EmailField(blank=True, max_length=254, null=True)),
                ('relation_ship', models.TextField(blank=True, choices=[('Father', 'Ota'), ('Mother', 'Ona'), ('Brother', 'Aka'), ('Sister', 'Singil'), ('Grand mother', 'Katta aka'), ('Grand father', 'Katta opa'), ('Other', 'Boshqa')])),
