    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted_as', models.CharField(choices=[('News', 'Yangilik'), ('Event', 'Voqelik')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semester', models.CharField(blank=True, choices=[('First', 'Birinchi'), ('Second', 'Ikkinchi'), ('Third', 'Uchinchi')], max_length=10)),
